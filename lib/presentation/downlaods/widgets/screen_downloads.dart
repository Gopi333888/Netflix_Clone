  ...
  Widget build(BuildContext context) {
    return const Row(children: [
      ...
      Text(
        'Smart Downloads',
        style: TextStyle(
            color: whiteClr, fontSize: 18, fontWeight: FontWeight.w900),
      )
    ]);
  }
}
    ...
    return Column(
      children: [
        const Text(
          ...
          style: TextStyle(
              color: whiteClr, fontSize: 22, fontWeight: FontWeight.w900),
        ),
        setHeight,
        const Padding(
        ...
        MaterialButton(
          ...
          child: const Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: blackClr, fontSize: 20, fontWeight: FontWeight.w900),
            ),
          ),
        )
      ],
